...
In your chosen IDE, navigate to the *src\test\java\<project>* folder and right-click to display the context menu. Select __New > Java Class__. Give the class a name and paste in the snippets.
