...
Or, if you don't know where to start, you can set a breakpoint in the method [`io.cucumber.java.Invoker#invoke`](https://github.com/cucumber/cucumber-jvm/blob/master/java/src/main/java/io/cucumber/java/Invoker.java#L27), at the line `return targetMethod.invoke(target, args)` (line 27 in `cucumber-jvm` master at the time of writing) and specify the following snippet as the condition:
...
3. Assuming you haven't set any other breakpoints, the execution will stop at `Invoker#invoke`
